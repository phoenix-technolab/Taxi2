...
export default function Promos() {
    const columns =  [
        ...
        { title: languageJson.start_date, field: 'promo_start', render: rowData => rowData.promo_start?new Date(rowData.promo_start).toLocaleDateString(dateStyle):null},
        { title: languageJson.end_date, field: 'promo_validity', render: rowData => rowData.promo_validity?new Date(rowData.promo_validity).toLocaleDateString(dateStyle):null},
